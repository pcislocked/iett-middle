...
Sits between the raw IETT/IBB APIs (SOAP, undocumented HTML, JSON) and your clients,
delivering clean versioned JSON with in-memory TTL caching and optional OSRM enrichment.
